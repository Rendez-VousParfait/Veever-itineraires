import { Article } from '../components/BlogSection';
...
export const blogArticles: Article[] = [
  ...
  {
    id: 5,
    titre: "Activités team building originales",
    description: "Renforcez la cohésion de votre équipe avec ces activités ludiques et créatives. Des concepts innovants pour sortir du cadre professionnel traditionnel.",
    image: "https://images.unsplash.com/photo-1528605248644-14dd04022da1?q=80&w=1200",
    tags: ["Groupes", "Team Building"],
    lien: "/blog/team-building"
  },
  {
    id: 6,
    titre: "Les meilleures tables gastronomiques",
    description: "Un tour d'horizon des restaurants qui font vibrer vos papilles et vous offrent une expérience culinaire d'exception. Des adresses incontournables pour les épicuriens.",
    image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=1200",
    tags: ["Food", "Gastronomie"],
    lien: "/blog/tables-gastronomiques"
  }
]; 